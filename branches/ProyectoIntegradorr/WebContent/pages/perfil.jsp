...
<div class="media">
	...
	<div class="media-body">
		...
		<s:property value="#session.keyUsuario.strNombre" /> 
		<s:property value="#session.keyUsuario.strApePaterno" />
		</h4>
...
<table class="table table-bordered">
	<tbody>
		...
		<tr>
			<td>Edad de Usuario</td>
			<td><s:property value="#session.keyUsuario.intEdad" /></td>
		</tr>
		<tr>
