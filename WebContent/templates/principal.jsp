...
<script type="text/javascript" src="angular/angular-locale_es-pe.js"></script>
<script type="text/javascript" src="src/controlador/registroCita.js"></script>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span3 bs-docs-sidebar"> 
				<tiles:insertAttribute name="opciones" />
			</div>
		</div>
