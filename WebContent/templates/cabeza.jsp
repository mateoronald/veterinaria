				...
				<div class="container-fluid">
					...
					<div class="nav-collapse collapse navbar-responsive-collapse">
						<ul class="nav">
							...
							<!-- Para poder hacer menus con sub-menus -->
							<!--  <li class="dropdown"><a data-toggle="dropdown"
								class="dropdown-toggle" href="#">Mantenimientos<strong
									class="caret"></strong>
							</a>
								<ul class="dropdown-menu">
									<li><a href="a_presentacion">Ventas</a></li>
									<li><a href="a_fortalezas">Facturación</a></li>
						...
						<ul class="nav pull-right">
							...
							<s:if test="%{#session.keyUsuario == null}">
								<li><a href="a_registro">Registrar</a></li>
